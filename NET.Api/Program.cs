...
if (AppSettingsHelper.Get("UseSwagger").ToBool())
{
    builder.Services.AddSwaggerGen(a =>
    {
        ...
        a.IncludeXmlComments(Path.Combine(basePath, "NET.Api.xml"), true);
        a.IncludeXmlComments(Path.Combine(basePath, "NET.Domain.xml"), true);
...
#region 注入xml注释
builder.Services.AddSingleton(XElement.Parse(File.ReadAllText(Path.Combine(basePath, "NET.Api.xml"))));
#endregion
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme).AddJwtBearer(options =>
{
    options.TokenValidationParameters = new TokenValidationParameters
    {
        ...
        ValidAudience = "netapi.com",
        ValidIssuer = "netapi.com",
